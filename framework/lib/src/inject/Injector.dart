...
/// A reserved name that can be used alongside a [provide] annotation.
///
/// A [Qualifier] further specifies a provided dependency, and the annotation
/// must be placed at the same level as a `@provide` annotation. It is
/// **illegal** to have more than one [Qualifier] for a given provider.
///
/// Example:
/// ```
...
/// Example:
/// ```
/// import 'coffee_shop.Injector.dart';
///
